---
id: guidance/front-load-critical
...
llm:
  # Ranking relative consequence across a whole directive list needs more than
  # pattern matching; low-effort judges split on it.
